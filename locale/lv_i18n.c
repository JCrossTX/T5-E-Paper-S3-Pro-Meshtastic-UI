...
static const lv_i18n_phrase_t el_singulars[] = {
    ...
    {"no public key", "Χωρίς κοινό κλειδί"},
    ...
    {"Modem Preset: custom", "Προκαθ. Modem: προσαρμοσμένο"},
...
static const lv_i18n_phrase_t hu_singulars[] = {
    ...
    {"Screen Timeout: 60s", "Kijelző kikap. idő: 60 mp"},
    {"Lock: off/off", "Zár: ki/ki"},
    {"Screen Brightness: 60%", "Fényerő: 60%"},
    {"Theme: Dark", "Téma: Sötét"},
    {"Screen Calibration: default", "Képernyő kalibrálás: alap"},
    {"Input Control: none/none", "Bemeneti vezérlés: nincs/nincs"},
    {"Message Alert Buzzer: on", "Üzenetjel. hang: be"},
    ...
    {"Public/Private Key", "Publikus/Privát kulcs"},
    ...
    {"Start", "Indítás"},
    {"choose\nnode", "válasszon\nnode-ot"},
    {"choose target node", "válasszon cél node-ot"},
    {"New Message from\n", "Új üzenet innen:\n"},
    ...
    {"Modem Preset: custom", "Modem preset: egyéni"},
    ...
    {"Filter: %d of %d nodes", "Szűrő: %d / %d node-ok"},
...
static const lv_i18n_phrase_t hu_plurals_one[] = {
...
static const lv_i18n_lang_t hu_lang = {.locale_name = "hu",
                                       .singulars = hu_singulars,
                                       .plurals[LV_I18N_PLURAL_TYPE_ONE] = hu_plurals_one,
                                       .plurals[LV_I18N_PLURAL_TYPE_OTHER] = hu_plurals_other,
                                       .locale_plural_fn = hu_plural_fn};
...
const lv_i18n_language_pack_t lv_i18n_language_pack[] = {
    &en_lang, &bg_lang, &cs_lang, &da_lang, &de_lang, &el_lang, &es_lang, &fi_lang, &fr_lang, &hu_lang, &it_lang,    &nl_lang,
