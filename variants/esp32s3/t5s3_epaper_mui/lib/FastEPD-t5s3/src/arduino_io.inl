...
//    else iDelay = 20;
    ...
    Wire.end();
    Wire.begin(sda, scl);
    // 100 kHz, which is what LilyGO runs these pins at
    // (epd_board_v7.c:124) - and this is the shared bus, carrying the
    // GT911, BQ25896, BQ27220, PCF8563 and PCA9535, not a private one.
    // See patches/0019.
    ...
    conf.master.clk_speed = 100000; // patches/0019 - factory speed
    conf.clk_flags = 0; 
