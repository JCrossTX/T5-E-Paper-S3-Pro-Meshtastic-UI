...
class LGFX_PICOMPUTER_S3 : public lgfx::LGFX_Device
{
    ...
    {
        {
            ...
            cfg.pin_mosi = 4;                  // Set SPI MOSI pin number
            cfg.pin_miso = -1;                 // Set SPI MISO pin number (-1 = disable)
            cfg.pin_dc = 1;                    // Set SPI DC pin number (-1 = disable)
        ...
        {                                        // Set the display panel control.
            ...
            cfg.pin_cs = 6;    // Pin number where CS is connected (-1 = disable)
        ...
        // Set the backlight control. (delete if not necessary)
        {
            ...
            cfg.pin_bl = 5;     // Pin number to which the backlight is connected
