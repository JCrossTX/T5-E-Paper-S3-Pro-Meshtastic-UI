  ...
  public:
    ...
    LGFX_HELTEC_TRACKER(void)
    {
        ...
        {                                        // Set the display panel control.
            ...
            cfg.offset_x = 27;              // Panel offset amount in X direction
            ...
            cfg.memory_width = 132;  // Maximum width supported by the driver IC
            cfg.memory_height = 162; // Maximum height supported by the driver IC
