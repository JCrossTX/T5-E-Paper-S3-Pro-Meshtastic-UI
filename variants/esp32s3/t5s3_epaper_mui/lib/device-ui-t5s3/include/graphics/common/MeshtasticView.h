...
class MeshtasticView : public DeviceGUI
{
  public:
    ...
    // The remaining four the radio streams. Present so a view that offers
    // these groups is not editing an all-zero shadow.
    virtual void updateStatusMessageModule(const meshtastic_ModuleConfig_StatusMessageConfig &cfg) {}
    virtual void updateTrafficManagementModule(const meshtastic_ModuleConfig_TrafficManagementConfig &cfg) {}
    virtual void updateTakModule(const meshtastic_ModuleConfig_TAKConfig &cfg) {}
    virtual void updateMeshBeaconModule(const meshtastic_ModuleConfig_MeshBeaconConfig &cfg) {}
