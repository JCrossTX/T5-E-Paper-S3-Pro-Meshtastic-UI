...
// Power-off helper for this variant: false while VBUS powers the system
// (shutdown is BATFET disconnect on the BQ25896 and would not take effect)
bool t5CanPowerOff();

// Frontlight duty helper for this variant (restored across sleep/shutdown)
...
// 4MHz: the SD library default; the SPI bus is shared with the SX1262
